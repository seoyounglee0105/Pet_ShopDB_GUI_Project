...
public class ProductDAO implements IProductDAO {
	...
	@Override
	public int update(int sales, int productId) {
		int result = 0;
		String sql = " UPDATE product SET sales = ? WHERE id = ? ";
	...
	@Override
	public ArrayList<ProductDTO> selectLike(String searchName) {
		ArrayList<ProductDTO> resultList = new ArrayList<>();
